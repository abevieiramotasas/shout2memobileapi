...
public class MainClass {
	...
	public static void main(String[] args) throws Exception {
		...
		mm.setMessageIn(Shout2Me.getAllMessageByIsland(101L, 0, 0L, true));
		for (MessageIn in : mm.getMessageIn()) {
